...
public class ChangeToStudentTableButton extends ChangeToTableButton {
    public ChangeToStudentTableButton(PageHandler pageHandler, JScrollPane sp, ManagementTable mTable,
        ...
        this.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                changeToTable(pageHandler, sp, mTable.getSTM(), mTable, aDButtons, dDButtons, eDButtons, 
